...
$b=$data->row_array();
?>
<form action="<?php echo base_url().'admin/produk/update_tulisan'?>" method="post" enctype="multipart/form-data">
<div class="row">
<div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Nama</h4>
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="xnama" class="form-control" value="<?php echo $b['tulisan_nama'];?>" placeholder="Judul">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                        <input type="hidden" name="kode" value="<?php echo $b['tulisan_id'];?>" required>
                            <input type="text" name="xharga" class="form-control" value="<?php echo $b['tulisan_harga'];?>" placeholder="Harga">
                        </div>
                    </div>
                    <div class="form-group">
                    <h4 class="card-title">Kategori</h4>
                        ...
                        <?php
                            ...
                            if($b['tulisan_id_kategori']==$kategori_id)
                ...
                <h4 class="card-title">Upload gambar</h4>
                    ...
                    <textarea class="form-control" rows="5" name="xisi"><?php echo $b['tulisan_isi'];?></textarea>
                </div>
                    <!-- <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">Deskripsi</h4>
                                        ...
                                        <textarea id="mymce" name="xisi" required><?php echo $b['tulisan_isi'];?></textarea>
                                </div>
                            </div>
                        </div>
                    </div> -->
