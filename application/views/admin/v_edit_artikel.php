...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>desain/assets/node_modules/html5-editor/bootstrap-wysihtml5.css" />
    <!-- Custom CSS -->
...
<body class="skin-default fixed-layout">
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $b=$data->row_array();
                ?>
                <form action="<?php echo base_url().'admin/Artikel/update_artikel'?>" method="post" enctype="multipart/form-data">
                <div class="row">
                <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Judul</h4>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="hidden" name="kode" value="<?php echo $b['artikel_id'];?>" required>
                                            <input type="text" name="xjudul" class="form-control" value="<?php echo $b['artikel_judul'];?>" placeholder="Judul">
                                        </div>
                                    </div>
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title">Deskripsi</h4>
                                                        ...
                                                        <textarea id="mymce" name="xisi" required><?php echo $b['artikel_deskripsi'];?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script src="<?php echo base_url();?>desain/assets/node_modules/tinymce/tinymce.min.js"></script>
    <script>
