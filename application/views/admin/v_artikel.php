                ...
                <div class="row">
                  <div class="col-12">
                      <div class="card">
                          <div class="card-body">
                              <td colspan="2">
                                <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/artikel/add_artikel'?>"><span class="fa fa-plus"></span> Add New</a>
                              </td>
                                      ...
                                      <tbody>
                                        <?php
                                					...
                                					foreach ($data->result_array() as $i) :
                                					   ...
                                					   $artikel_isi=$i['artikel_deskripsi'];
                                					   $artikel_tanggal=$i['tanggal'];
                                					   $artikel_gambar=$i['artikel_image'];

                                        ?>
                                          <tr>
                                            <td><img src="<?php echo base_url().'desain/frontend/images/'.$artikel_gambar;?>" style="width:90px;"></td>
                                            <td><?php echo $artikel_judul;?></td>
                                            <td><?php echo $artikel_isi;?></td>
                                  	        <td><?php echo $artikel_tanggal;?></td>

                                            <td style="text-align:right;">
                                                  <a class="btn" href="<?php echo base_url().'admin/artikel/get_edit/'.$artikel_id;?>"><span class="fa fa-pencil"></span></a>
                                                  <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $artikel_id;?>"><span class="fa fa-trash"></span></a>
                                            </td>
                                          </tr>
                          				<?php endforeach;?>
                                      </tbody>
