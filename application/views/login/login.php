...
<head>
    ...
    <title>ADMIN PUASIN JEMBER</title>
...
<body class="skin-default card-no-border">
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?php echo base_url(); ?>desain/bg.jpg);">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="<?php echo base_url(); ?>Login/aksi_login" method="post">
                        <h3 class="box-title m-b-20" align="center">LOGIN ADMIN PUASIN JEMBER<?php echo @$message; ?></h3>
