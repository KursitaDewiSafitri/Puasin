        ...
        <div class="page-wrapper">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <td colspan="2">
                                    <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#myModal">Tambah Testimoni</button>
                                </td>
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        ?>
                                        <tr>
                                        <td><img src="<?php echo base_url().'desain/frontend/images/testi/'.$galeri_gambar;?>" style="width:80px;"></td>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/testimoni/simpan_galeri'?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     <input type="hidden" value="<?php echo $galeri_gambar;?>" name="gambar">
                            ...
                            <p>Apakah Anda yakin mau menghapus testimoni <b><?php echo $galeri_judul;?></b> ?</p>
