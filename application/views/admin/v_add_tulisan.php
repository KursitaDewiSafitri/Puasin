    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Info box -->
                <!-- ============================================================== -->
                <form action="<?php echo base_url().'admin/produk/simpan_tulisan'?>" method="post" enctype="multipart/form-data">
                <div class="row">
                <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nama produk</h4>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="text" name="xnama" class="form-control" placeholder="Nama Produk">
                                        </div>
                                    </div>
                                    <h4 class="card-title">Harga</h4>
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            <input type="text" name="xharga" class="form-control" placeholder="Harga">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <h4 class="card-title">Upload gambar</h4>
                                    ...
                                    <textarea class="form-control" rows="5" name="xisi"></textarea>
                                </div>
                                    <!-- <div class="form-group">
                                        <div class="col-md-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <h4 class="card-title">Deskripsi</h4>
                                                        ...
                                                        <textarea id="mymce" name="xisi"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div> -->
