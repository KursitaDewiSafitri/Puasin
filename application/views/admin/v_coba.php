                          ...
                          <li class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
                                  <ul>
                                      ...
                                      <li>
                                          <a class="nav-link text-center link" href="<?php echo base_url().'admin/inbox'?>"> <strong>Lihat Semua Pesan</strong> <i class="fa fa-angle-right"></i> </a>
                                      </li>
                                       -->
                                  </ul>
                              </div>
                ...
                <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <td colspan="2">
                                        <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#myModal">Tambah Kategori</button>
                                    </td>
