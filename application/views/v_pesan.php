...
<html lang="en">
 ...
 <!--== 15. Reserve A Table! ==-->
                ...
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
                            <h2 class="section-title">Catering Puas-in Jember</h2>
                        </div>
        ...
        <section class="contact-form">
            <div class="container">
                <div class="row">
                    <h1><center><b>Pemesanan Catering Puasin Jember</b></center></h1>
                    <h3><center>Kirim Format Order</center></h3>
                    <p><center>Nama-No.Telp-Tanggal Pemesanan & jam-Tujuan Antar-jenis Pesanan-Jenis Pembayaran</center></p>
                    <p>Contoh Format Order:</p>
                    ...
                    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
                        <div class="row">
                             <form class="contact-form" method="post" action="contact.php">
                                <p><center>Klik Tombol Dibawah untuk pemesanan</center></p>
                                    <div class="text-center">
                                        <button type="submit" id="submit" name="submit" class="btn btn-send"><a href="https://api.whatsapp.com/send?phone=6282144770224&text=*Selamat*%20*Order*%20*di*%20*Puasin*%20*Jember*%20%0ANama%20%3A%0ANo.Telp%20%3A%0ATanggal%20Pemesanan%20dan%20Jam%20%3A%0ATujuan%20Antar%20%3A%0AJenis%20Pesanan%20%3A%0AJenis%20Pembayaran%20%3A" style="color:#ffffff">
                                        <span><i class="fa fa-check-circle-o"></i></span> WA : Puasin Jember </button>
                                    </div>
                                </div>
                            </form>
                        </div>
