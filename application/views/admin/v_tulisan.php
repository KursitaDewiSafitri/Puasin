                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <td colspan="2">
                                  <a class="btn btn-success btn-rounded" href="<?php echo base_url().'admin/Produk/add_tulisan'?>"><span class="fa fa-plus"></span> Add New</a>
                                </td>
                                <div class="table-responsive">
                                    ...
                                    <?php
                                        ...
                                        $no++;
                                            ...
                                            $tulisan_nama=$i['tulisan_nama'];
                                            $tulisan_harga=$i['tulisan_harga'];
                                            $tulisan_isi=$i['tulisan_isi'];
                                            $tulisan_tanggal=$i['tanggal'];
                                            $tulisan_gambar=$i['tulisan_gambar'];
                                            $id_kategori=$i['tulisan_id_kategori'];
                                            $nama_kategori=$i['tulisan_nama_kategori'];
                                    ?>
                                        <tr>
                                            <td><img src="<?php echo base_url().'desain/frontend/images/'.$tulisan_gambar;?>" style="width:100px;"></td>
                                            <td><?php echo $tulisan_nama;?></td>
                                            <td><?php echo $tulisan_harga;?></td>
                                            <td><?php echo $tulisan_isi;?></td>
                                            <td><?php echo $tulisan_tanggal;?></td>
                                            <td><?php echo $nama_kategori;?></td>

                                            <td style="text-align:center;">
                                                <a class="btn" href="<?php echo base_url().'admin/produk/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                     ...
                     <input type="hidden" value="<?php echo $tulisan_gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Produk <b><?php echo $tulisan_nama;?></b> ?</p>
